...
const ConfigErrorScreen = ({ onRetry }) => {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-primary bg-opacity-85 text-tertiary p-4 text-center">
            ...
            <button
                onClick={onRetry}
                className="bg-secondary text-tertiary px-4 py-2 rounded-md transition-all hover:bg-secondary-red duration-300 focus:outline-none focus:ring-2"
            >
                Tekrar dene / Retry
            </button>
        </div>
